        ...
        function n(a, t) {
            ...
            n.onload = function (a) {
                $(e + " #prev_" + t).find("img").attr("src", a.target.result),
                        $(e + " #prev_" + t).removeClass("hidden"), $(e + " #new_" + t).addClass("hidden"),
                ...
                if (f.length > 0)
                    for (f.html(""); o < a; o++)
                        f.append((c = o, u = r.join(","), '<div class="box-drag column" draggable="true">\n\
                                                                ...
                                                                <div class="form-group"><div class="w3-col m12 no-padding uploadArea" data-index="' + c + '">\n\
                                                                ...
                                                                <span class="image-preview hidden" id="prev_' + c + '">\n\
                                                                <div class="remove" title="' + i + '" data-index="' + c + '">\n\
                                                                <i class="' + d + '"></i></div><img class="img-responsive" src="">\n\
                                                                </span>\n\
                                                                </div>\n\
                                                                </div>\n\
                                                            </div>'));
